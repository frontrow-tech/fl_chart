...
abstract class AxisChartPainter<D extends AxisChartData>
  ...
  void _drawRangeAnnotation(CanvasWrapper canvasWrapper) {
    ...
    if (data.rangeAnnotations.rectangleRangeAnnotation.isNotEmpty) {
      for (var annotation in data.rangeAnnotations.rectangleRangeAnnotation) {
        final from = Offset(getPixelX(annotation.x1, chartUsableSize),
            getPixelY(annotation.y1, chartUsableSize));
        ...
        final rect = RRect.fromRectAndRadius(
          ...
          Radius.circular(annotation.radius),
        );
