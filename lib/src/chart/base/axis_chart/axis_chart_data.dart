...
class RangeAnnotations with EquatableMixin {
  ...
  final List<RectangleRangeAnnotation> rectangleRangeAnnotation;
  ...
  RangeAnnotations({
    ...
    this.rectangleRangeAnnotation = const [],
  });
  ...
  static RangeAnnotations lerp(
    ...
    return RangeAnnotations(
      ...
      rectangleRangeAnnotation: lerpRectangleRangeAnnotation(
          a.rectangleRangeAnnotation, b.rectangleRangeAnnotation, t),
    );
  }
...
/// Defines an annotation region in x (horizontal) axis.
class RectangleRangeAnnotation with EquatableMixin {
  /// Determines starting point in horizontal (x) axis.
  final double x1;
  ...
  /// Lerps a [VerticalRangeAnnotation] based on [t] value, check [Tween.lerp].
  static RectangleRangeAnnotation lerp(
    RectangleRangeAnnotation a,
    RectangleRangeAnnotation b,
    double t,
  ) {
    return RectangleRangeAnnotation(
      x1: lerpDouble(a.x1, b.x1, t),
      x2: lerpDouble(a.x2, b.x2, t),
      y1: lerpDouble(a.y1, b.y1, t),
      y2: lerpDouble(a.y2, b.y2, t),
