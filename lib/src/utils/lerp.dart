...
/// Lerps [RectangleRangeAnnotation] list based on [t] value, check [Tween.lerp].
List<RectangleRangeAnnotation> lerpRectangleRangeAnnotation(
        List<RectangleRangeAnnotation> a,
        List<RectangleRangeAnnotation> b,
        double t) =>
    _lerpList(a, b, t, lerp: RectangleRangeAnnotation.lerp);
